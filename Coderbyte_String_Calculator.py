# Using the JavaScript language, have the function Calculator(str) take the str parameter being passed and evaluate
...
# The string will contain the operators: +, -, /, *, (, and ). If you have a string like this: #/#*# or #+#(#)/#, then
# evaluate from left to right. So divide then multiply, and for the second one multiply, divide, then add.
...
print(int(pandas.eval("6*(4/2)+3*1")))
print(int(pandas.eval("6/3-1")))
print(int(pandas.eval("(2-0)*(6/2)")))
